...
$query = mysqli_query($conn, "
    SELECT booking.*, users.nama, users.email, lapangan.nama_lapangan, lapangan.jenis_lapangan
    FROM booking
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        ...
        <div>
            ...
            <a href="booking.php" class="btn btn-warning btn-sm me-2">Kelola Booking</a>
...
<div class="container mt-5">
    ...
    <p class="text-muted mb-4">Admin dapat menyetujui atau membatalkan booking lapangan.</p>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($data['status_booking'] == 'pending') { ?>
                                        <a href="ubah_status_booking.php?id_booking=<?php echo $data['id_booking']; ?>&status=disetujui" 
                                           class="btn btn-success btn-sm mb-1"
                                           onclick="return confirm('Setujui booking ini?')">
                                            Setujui
                                        </a>

                                        <a href="ubah_status_booking.php?id_booking=<?php echo $data['id_booking']; ?>&status=dibatalkan" 
